...
OMP_NUM_THREADS=2 python utils/train_resnet.py --net-name ResNet50 --gpu-ids 0 --batch-size 64 --nThreads 2 --log-dir ./logs/backbone/ResNet50 --tensor-dir ./tensor_logs/backbone/ResNet50 --save-dir ./models/backbone --start 37
