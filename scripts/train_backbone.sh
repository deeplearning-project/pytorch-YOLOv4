...
OMP_NUM_THREADS=4 python utils/train_resnet.py --net-name ResNet50 --gpu-ids 0,1 --batch-size 128 --nThreads 4 --log-dir ./logs/backbone/ResNet50 --tensor-dir ./tensor_logs/backbone/ResNet50 --save-dir ./models/backbone --start 69
